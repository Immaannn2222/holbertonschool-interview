...
*@s:  string to scan
*@words: double pointer to the array of words all substrings
*@nb_words: number of elements in the array words
*@n: address at which to store the number of elements in the return
*
*Return: each index in s, at which a substring was found or NULL
*/
...
int *find_substring(char const *s, char const **words, int nb_words, int *n)
{
	...
	if (!s || !words || strlen(s) < strlen(*words))
		return (NULL);
